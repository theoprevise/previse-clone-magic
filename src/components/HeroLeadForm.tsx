...
const HeroLeadForm = () => {
  ...
  return (
    <div className="bg-white/95 backdrop-blur-md rounded-2xl p-6 md:p-8 shadow-2xl border border-white/20">
      <h3 className="text-2xl font-bold text-primary mb-2 text-center">Get Started Today</h3>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex items-start gap-3">
          ...
          <label htmlFor="consent" className="text-xs text-gray-500 leading-relaxed cursor-pointer">
            I consent to receive texts and calls, including marketing, from Previse Mortgage. This consent is not a condition of purchase.
          </label>
        </div>
        ...
        <Button
          ...
          className="w-full bg-gradient-to-r from-accent to-accent-light hover:from-accent-light hover:to-accent text-primary font-bold py-6 text-lg rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
        >
          {isSubmitting ? (
            <>

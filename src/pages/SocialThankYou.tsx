            ...
            <div className="mb-8 animate-slide-up" style={{animationDelay: '0.2s'}}>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20 shadow-medium">
                <p className="text-white/90 text-xl lg:text-2xl leading-relaxed">
                  We're thrilled to have you as part of our social community. Stay tuned for valuable content and updates!
                </p>
              </div>
            </div>
              ...
              <div className="bg-accent/10 backdrop-blur-sm rounded-xl p-6 border border-accent/20 shadow-accent">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-left">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Daily Tips</p>
                      <p className="text-white/70 text-sm">Follow us for daily mortgage and homebuying insights.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm">Stay informed about local real estate trends.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <Gift className="w-5 h-5 text-accent mt-1 flex-shrink-0" />
                    <div>
                      <p className="text-white font-medium">Giveaways</p>
                      <p className="text-white/70 text-sm">Participate in exclusive contests and giveaways.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="mb-8 animate-slide-up" style={{animationDelay: '0.5s'}}>
              <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
                <p className="text-white/80 text-lg">
                  <strong className="text-accent">Don't miss out:</strong> Make sure to follow us on all our social channels to stay up-to-date with the latest news and tips!
                </p>
              </div>
            </div>

    ...
    if (currentStep < totalSteps) {
      ...
      try {
        const applicationData = {
          ...
          military_service: Array.isArray(formData.militaryService) ? formData.militaryService : (formData.militaryService ? [formData.militaryService] : null),
          down_payment: formData.downPayment,
          savings_amount: formData.savingsAmount,
          financial_institutions: Array.isArray(formData.financialInstitutions) ? formData.financialInstitutions : (formData.financialInstitutions ? [formData.financialInstitutions] : null),

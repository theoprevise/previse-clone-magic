        ...
        <div className="text-center">
          ...
          <div className="space-y-2 text-white/60 text-sm max-w-3xl mx-auto">
            ...
            <p className="text-white/40 text-xs mt-2">
              Previse Mortgage LLC is a U.S.-based mortgage brokerage licensed in Pennsylvania and Colorado for residential lending, with investment property financing arranged where permitted by state law.

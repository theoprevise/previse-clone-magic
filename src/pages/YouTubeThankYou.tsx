...
import { CheckCircle, Home, Youtube, Bell, PlayCircle } from "lucide-react";
import { useNavigate } from "react-router-dom";
import SEOHead from "@/components/SEOHead";

const YouTubeThankYou = () => {
  ...
  return (
    <div className="min-h-screen animate-gradient-shift bg-gradient-to-br from-primary via-primary-dark via-secondary to-primary-dark bg-[length:400%_400%]">
      <SEOHead title="Welcome to the Community | Previse Mortgage" noIndex={true} />
            ...
            <div className="mb-8 animate-slide-up" style={{animationDelay: '0.2s'}}>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20 shadow-medium">
                <p className="text-white/90 text-xl lg:text-2xl leading-relaxed">
                  Thanks for connecting with us! You're now part of our growing community of homebuyers and real estate enthusiasts.
                </p>
              </div>
            </div>
              ...
              <div className="bg-accent/10 backdrop-blur-sm rounded-xl p-6 border border-accent/20 shadow-accent">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-left">
                  <div className="flex items-start gap-3">
                    <Youtube className="w-5 h-5 text-accent mt-1 flex-shrink-0" />
                    <div>
                      <p className="text-white font-medium">Video Updates</p>
                      <p className="text-white/70 text-sm">Be the first to know when we drop new content.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <PlayCircle className="w-5 h-5 text-accent mt-1 flex-shrink-0" />
                    <div>
                      <p className="text-white font-medium">Exclusive Tips</p>
                      <p className="text-white/70 text-sm">Get mortgage and homebuying tips straight to your inbox.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm">Receive exclusive deals and early access to events.</p>
                    </div>
                  </div>
                </div>
              </div>
...
export default YouTubeThankYou;
